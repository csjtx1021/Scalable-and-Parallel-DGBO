...
def ChooseNext_batch(data,info):
    ...
    while len(info.pending_set)<info.max_pending:
        ...
        if len(info.pending_set)==0:
            ...
            """
            phi_star=AdaptiveBasis.AdaptiveBasis(data,info,data.candidates[random_can],False,False,False)
            ...
            """
            phi_matrix_pending=AdaptiveBasis.AdaptiveBasis(data,info,data.candidates[info.pending_set],False,False,False)
